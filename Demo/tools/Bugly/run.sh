...
#
# #
# BUGLY_APP_ID="9f15241a2b"
# # #
# BUGLY_APP_KEY="58133498-6d66-4a9c-9235-2bd442e5a4a8"
# # #
# BUNDLE_IDENTIFIER="${development_bundle_id}"
# #
UPLOAD_DSYM_ONLY=1
#
...
BUGLY_SYMBOL_JAR_PATH="buglySymboliOS.jar"
# 查找添加到系统目录的jar工具
