...
extern NSString *SDMemoryCacheInfoKindKey;
extern NSString *SDMemoryCacheInfoHitRatioKey;
extern NSString *SDMemoryCacheInfoAverageQueryTimeKey;
extern NSString *SDMemoryCacheInfoTotalQueryCountKey;
extern NSString *SDMemoryCacheInfoNotification;
